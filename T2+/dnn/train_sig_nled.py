...
resultTxt = "result_1210_88var.txt"
resultDir = "/home/juhee5819/T2+/result/1210_88var/"
...
plt.savefig(os.path.join(resultDir,'Loss_pt20_default_N'+str(node)+'L'+str(layer)+'E'+str(epochs)+'D'+str(dropout)+'.pdf'))
plt.gcf().clear()
...
plt.savefig(os.path.join(resultDir, 'HM_pt20_default_N'+str(node)+'L'+str(layer)+'E'+str(epochs)+'D'+str(dropout)+'.pdf'))
plt.show()
plt.gcf().clear()
