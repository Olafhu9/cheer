...
resultTxt = "result_0131_v4.txt"
resultDir = "/home/juhee5819/T2+/result/0131_v4"
...
#ttbb_jet_list = [ (len(data_ttbb.loc[data_ttbb['jet_perm']==i])) for i in range() ]
...
train_jet_input = train_jet_input.reshape( train_jet_input.shape[0], 6, -1, 1 )
...
valid_jet_input = valid_jet_input.reshape( valid_jet_input.shape[0], 6, -1, 1 )
...
#    f_log.write('ttbb jet perm list '+str(ttbb_jet_list)+' '+str(sum(ttbb_jet_list))+'\n')
#    f_log.write('ttcc jet perm list '+str(ttcc_jet_list)+' '+str(sum(ttcc_jet_list.sum))+'\n')
#    f_log.write('ttLF jet perm list '+str(ttLF_jet_list)+' '+str(sum(ttLF_jet_list.sum))+'\n')
