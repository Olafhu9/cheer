...
resultTxt = "result_0126_v1_4.txt"
resultDir = "/home/juhee5819/T2+/result/0126_v1_4"
...
label_event = ['ttbb', 'ttcc', 'ttLF']
# Heatmap for jet permutation
plt.rcParams['figure.figsize'] = [7.5, 6]
cfmt = lambda x,pos: '{:.0%}'.format(x)
heatmap = sns.heatmap(conf_jet/sum_jet, xticklabels=label_event, yticklabels=label_event, annot=True, cmap='YlGnBu', fmt='.1%', annot_kws={"size":12}, vmax=1, cbar_kws={'format': FuncFormatter(cfmt)} )
