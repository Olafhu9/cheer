...
# Dense for event
event_info = Dense(20, activation='relu')(event_info)
...
jets = Conv1D( 8, 1, kernel_initializer='lecun_uniform',  activation='relu', name='jets_conv1')(jets)
jets = Dropout(dropout)(jets)
...
svtx = Conv1D( 32, 1, kernel_initializer='lecun_uniform',  activation='relu', name='svtx_conv0')(svtx)
svtx = Dropout(dropout)(svtx)
svtx = Conv1D( 8, 1, kernel_initializer='lecun_uniform',  activation='relu', name='svtx_conv1')(svtx)
#svtx = Dropout(dropout)(svtx)
...
cpf = Conv2D( 32, (1,2), kernel_initializer='lecun_uniform',  activation='relu', name='cpf_conv0')(cpf)
cpf = Dropout(dropout)(cpf)
cpf = Conv2D( 8, (1,2), kernel_initializer='lecun_uniform',  activation='relu', name='cpf_conv1')(cpf)
cpf = Dropout(dropout)(cpf)
...
# Concatenate
x = Concatenate()( [event_info, jets, svtx, cpf] )
#x = Concatenate()( [event_info, jets, svtx] )
...
plot_model(model, to_file='model_sv__plot.png', show_shapes=True, show_layer_names=True)
